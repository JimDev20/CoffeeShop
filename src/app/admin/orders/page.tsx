...
export default async function AdminOrdersPage() {
  let orders = await orderService.getAll().catch(() => []);
          ...
          <Card key={order.id}>
            <CardContent className="p-4 flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-stone-500">{orderService.formatDate(order.created_at)} &middot; {orderService.itemCount(order.items)} items</p>
              </div>
