...
- No credentials - passwords, API keys, tokens, connection strings. apply this in the project and then change the readme without any credentials or setup in credentials
